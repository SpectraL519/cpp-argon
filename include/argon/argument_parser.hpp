...
//     return this->_parser->value_or<T>(this->_format_arg_name(arg_base_name), std::forward<U>(fallback_value));
// }
...
// inline bool argument_group::is_used(std::string_view arg_base_name) const {
//     return this->_parser->is_used(this->_format_arg_name(arg_base_name));
// }

// inline bool argument_group::has_value(std::string_view arg_base_name) const {
//     return this->_parser->has_value(this->_format_arg_name(arg_base_name));
// }

// inline std::size_t argument_group::count(std::string_view arg_base_name) const {
